"""Headline analysis, lexicon-v3: the analyzer the server used until lexicon-v4 (news.py).

Kept unchanged so research that compares the two (research_news_v4.py, research_news.py) can be rerun;
headlines stored by the server keep the analysis they were given (their ``by`` field says which).
"""
